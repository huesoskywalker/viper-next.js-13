    ...
    return (
        <div className="py-2">
            ...
            <div className="w-full">
                ...
                <div>
                    <button
                        className="relative w-3/6 items-center  space-x-2 rounded-lg bg-red-700 my-3 ml-28 py-2 text-sm font-medium text-white hover:bg-vercel-blue/90 disabled:text-white/70"
                        disabled={isPending}
