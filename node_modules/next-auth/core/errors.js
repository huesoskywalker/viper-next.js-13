...
var UnknownAction = function (_UnknownError10) {
  (0, _inherits2.default)(UnknownAction, _UnknownError10);

  var _super11 = _createSuper(UnknownAction);

  function UnknownAction() {
    var _this11;

    (0, _classCallCheck2.default)(this, UnknownAction);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this11), "name", "UnknownAction");
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this11), "code", "UNKNOWN_ACTION_ERROR");
    return _this11;
  }

  return (0, _createClass2.default)(UnknownAction);
}(UnknownError);

exports.UnknownAction = UnknownAction;

var UntrustedHost = function (_UnknownError11) {
  (0, _inherits2.default)(UntrustedHost, _UnknownError11);

  var _super12 = _createSuper(UntrustedHost);

  function UntrustedHost() {
    var _this12;

    (0, _classCallCheck2.default)(this, UntrustedHost);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this12), "name", "UntrustedHost");
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this12), "code", "UNTRUST_HOST_ERROR");
    return _this12;
  }

  return (0, _createClass2.default)(UntrustedHost);
}(UnknownError);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              for (_len12 = _args2.length, args = new Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {
                args[_key12] = _args2[_key12];
              }
